...
const PATH = "/guides";
const TITLE = "TTML and Synced Lyrics Guides ・ RichLyricEditor";
const DESCRIPTION =
  ...
  return (
    <LandingLayout>
      ...
      <section className="px-6 py-16 md:py-24 max-w-4xl mx-auto">
        <p className="text-xs font-medium tracking-wide text-composer-accent-text mb-4 select-none">
          Guides
        </p>
        ...
        <p className="text-lg text-composer-text-secondary max-w-2xl">
          Everything you need to ship great synced lyrics. Start with the
          fundamentals, then move into platform-specific workflows and advanced
          techniques.
        </p>
      </section>
            ...
            <li key={guide.slug}>
              ...
              >
                <div className="flex-1 min-w-0">
                  <h2 className="text-lg font-semibold text-composer-text mb-1">
                    {guide.title}
                  </h2>
